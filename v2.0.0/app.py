...
def main():
    ...
    try:
        ...
        - **📝 Feedback & Satisfaction**: User feedback, sessions, engagement, and feature events
        ...
        # Refresh data button
        if st.sidebar.button("🔄 Refresh Data", help="Clear cache and reload data from S3", width='stretch'):
            # Clear cache and session state data flags
            st.cache_data.clear()
            st.session_state.data_loaded = False
